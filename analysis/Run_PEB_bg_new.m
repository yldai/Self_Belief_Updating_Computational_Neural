%% Parametric Empirical Bayes (PEB), Model 2 sensitivity analysis

% This script reproduces the PEB model 1 sensitivity analysis results
% reported in the Dai et al. Supplementary Results 7 and Supplementary
% Table 10.
