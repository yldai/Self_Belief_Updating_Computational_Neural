...
% This adapted model determines favorability based on  participants' own 
% word valence ratings, with ratings of 4-5 converted to +1 - positive, 
%ratings of 1-2 converted to -1 - negative, and ratings of 3 converted to
% 0 - neutral.
%
% AUTHOR / DATE
...
%   E1, E2, BR, V  (each Sx1 cell; contents are column vectors)

assert(iscell(E1) && iscell(E2) && iscell(BR) && iscell(V), ...
    'E1, E2, BR, V must be Sx1 cell arrays.');
