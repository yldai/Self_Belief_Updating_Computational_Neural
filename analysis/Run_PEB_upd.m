...
% reported in the Dai et al. manuscript (Figure 5, Table 2).
...
save('/data/projects/punim1864/yingliang/spartan_scripts/DCM_scripts/specify/est_infer/PEB_AB_all_upd.mat', 'PEB', 'RCM');

% PEB model comparison (automatic search over reduced PEB models)
BMA = spm_dcm_peb_bmc(PEB);
save('/data/projects/punim1864/yingliang/spartan_scripts/DCM_scripts/specify/est_infer/BMA_search_AB_all_upd.mat', 'BMA');
